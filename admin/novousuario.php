...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['imagem']) && $_FILES['imagem']['error'] === UPLOAD_ERR_OK) {
        ...
        $imagem_destino = 'caminho/para/salvar/as/imagens/' . $imagem_nome; // Especifique o caminho onde deseja salvar as imagens
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <form action="adicionar_usuario.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="pass-group">
                                            <input type="password" name="senha" class="pass-input form-control">
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                ...
                                <div class="form-group">
                                    <label>Perfil</label>
                                    <select class="select form-control" name="perfil">
