...
<div class="main-wrapper">
    ...
    <div class="header">
        ...
        <div class="header-left active">
            <a id="sidebar_toggle_btn" class="sidebar-toggle-btn" href="javascript:void(0);">
            ...
            <li class="nav-item dropdown has-arrow main-drop">
                ...
                <div class="dropdown-menu menu-drop-user">
                    <div class="profilename">
                        ...
                        <hr class="m-0">
                        <a class="dropdown-item logout pb-0" href="signin.html"><img src="assets/img/icons/log-out.svg" class="me-2" alt="img">Sair</a>
                    </div>
                </div>
            </li>
        </ul>
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="nome_arquivo" name="nome_arquivo" required>
                                        ...
                                        // Loop através de cada linha de resultado
                                        while ($row = $result->fetch_assoc()) {
                                            echo '<option value="' . $row["nome_arquivo"] . '">' . $row["nome_arquivo"] . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
